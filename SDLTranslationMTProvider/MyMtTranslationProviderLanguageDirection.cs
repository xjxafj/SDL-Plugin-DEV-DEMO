...
{
    public class MyMtTranslationProviderLanguageDirection : ITranslationProviderLanguageDirection
    {
        private readonly MyMtTranslationProvider _deepLMtTranslationProvider;
        private readonly MyMtTranslationOptions _options;
        private readonly LanguagePair _languageDirection;
        private TranslationUnit _inputTu;
        private MyMtTranslationProviderConnecter _deeplConnect;
        ...
        private string LookupDeepl(string sourcetext)
        {
            ...
            {
                _deeplConnect = new MyMtTranslationProviderConnecter(_options.ApiKey);
            }
            else
            {
